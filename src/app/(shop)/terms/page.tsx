...
const SECTIONS = [
  ...
  ["Rétractation & retours", `En cas de défaut ou de non-conformité constaté à la réception, contactez-nous sous 48h à ${CONTACT.email} ou au ${CONTACT.phone}. Selon l'état du produit, nous organisons l'échange ou le remboursement.`],
